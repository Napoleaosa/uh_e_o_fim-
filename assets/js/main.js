...
const sendEmail = (e) =>{
    ...
    // Show message
        ...
        // serviceID - templateID - #fone - publicKey
        emailjs.sendForm('service_q6eken8','template_exe0wgo','#contact-form','LskPIY96mfQF14PxH')
            .then(() =>
...
const scrollup = () =>{
  ...
  // when the scroll is higher than 350 viewport height, add the show-scroll to the tag with the scrollup
...
if (selectedtheme) {
    //If the validation is fulfilled, we ask what the issuee was to know if we activated os deactivated the dark theme 
...
sr.reveal('.skills__content:nth-child(1), .contact__conten:nth-child(1)', {origin: 'left'})
sr.reveal('.skills__content:nth-child(2), .contact__conten:nth-child(2)', {origin: 'right'})
